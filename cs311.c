...
void initialize(char *program_filename) { 
    ...
    CURRENT_STATE.ID_EX_ZERO_EXT_IMM = 0;
	CURRENT_STATE.ID_EX_DEST_REG = 0;
	CURRENT_STATE.ID_EX_stall_or_no_inst = 1;

    CURRENT_STATE.EX_MEM_INST = 0;
	CURRENT_STATE.EX_MEM_NPC = 0;

    CURRENT_STATE.EX_MEM_WRITE_VALUE = 0;
    CURRENT_STATE.EX_MEM_BR_TAKE = 0;
	CURRENT_STATE.EX_MEM_DEST_REG = 0;
	CURRENT_STATE.EX_MEM_stall_or_no_inst = 1;

    CURRENT_STATE.MEM_WB_INST = 0;
	CURRENT_STATE.MEM_WB_NPC = 0;
    CURRENT_STATE.MEM_WB_MEM_OUT = 0;
	CURRENT_STATE.MEM_WB_DEST = 0;
	CURRENT_STATE.MEM_WB_stall_or_no_inst = 1;

    CURRENT_STATE.EX_MEM_ALU_FORWARD_VALUE = 0;
	CURRENT_STATE.MEM_WB_ALU_FORWARD_VALUE = 0;
	CURRENT_STATE.MEM_WB_to_MEM_DATA_FORWARD_VALUE = 0;
